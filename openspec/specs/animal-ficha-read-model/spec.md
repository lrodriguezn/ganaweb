# Animal Ficha Read Model Specification

## Purpose

Define the enriched `obtenerFichaAnimal` projection: resolved raza/color names, computed age, latest weighing with GDP, reproductive summary derived from events, and latest body condition. Unavailable values MUST be absent, never fabricated.
