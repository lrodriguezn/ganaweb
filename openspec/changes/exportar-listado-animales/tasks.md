...
| 4.3 [x] | GREEN create route `apps/web/src/routes/api/fincas/$fincaId/animales/exportar.ts` (mirror `animales.ts`; wire deps) | LA-070 | contract via route | 40 |
| 4.4 [x] | REFACTOR typecheck+biome web | — | green | 3 |
