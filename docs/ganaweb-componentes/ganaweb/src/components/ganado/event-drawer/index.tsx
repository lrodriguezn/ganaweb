...
export interface EventDrawerProps {
  ...
  /** Callback al confirmar: el padre inserta en SQLite local + outbox */
  onGuardar: (payload: {
    tipo: TipoEvento;
    animales: AnimalResumen[];
    datos: Record<string, unknown>;
  }) => Promise<void>;
  /** Loader de animales por lote — leído de la réplica local, no de red */
      ...
      >
        ...
        {paso === "formulario" && tipo === "vacuna" && (
          <FormularioVacuna
            ...
            onVolver={preseleccion ? undefined : () => setAnimales([])}
          />
        )}
