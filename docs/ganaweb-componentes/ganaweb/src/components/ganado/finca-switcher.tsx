...
import { Check, CloudOff, ChevronDown, Plus, Search } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuTrigger,
 ...
 * - Sin conexión, las fincas SIN réplica local se muestran deshabilitadas
 *   (nunca ocultas) con "Requiere conexión · sin datos locales".
